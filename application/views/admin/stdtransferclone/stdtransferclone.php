        ...
        <div class="row">           
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form id='form1' action="<?php echo site_url('admin/stdtransferclone/index') ?>"  method="post" accept-charset="utf-8">
                        <div class="box-body">
                            ...
                            <form action="#" method="post" accept-charset="utf-8" class="promote_form">
                                ...
                                <div class="table-responsive">    
                                    <table class="table table-striped">
                                        <tbody>
                                            <tr>
                                                <th>Select All <input type="checkbox" id="select_all" name="select_all" value="1"></th>
                                            ...
                                            <?php if (empty($resultlist)) {
                                                ...
                                                <tr>
                                                    <td><?php echo $count_checkbox; ?> <input type="checkbox" name="student_list[]" value="<?php echo $student['id']; ?>"></td>
    ...
    $(document).ready(function () {
        ...
        $('#pramoteStudentModal').on('click', '.pramote_student', function (e) {
            ...
            $.ajax({
                ...
                url: '<?php echo site_url("admin/stdtransferclone/promote") ?>',
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#select_all').on('change', function() {
            ...
            $('input[name="student_list[]"]').prop('checked', isChecked);
        });

        // Update select_all checkbox state when individual checkboxes are changed
        $(document).on('change', 'input[name="student_list[]"]', function() {
            var totalCheckboxes = $('input[name="student_list[]"]').length;
            var checkedCheckboxes = $('input[name="student_list[]"]:checked').length;

...
class Stdtransferclone extends Admin_Controller {
    ...
    function index() {
        ...
        $this->session->set_userdata('sub_menu', 'stdtransferclone/index');
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->load->view('admin/stdtransferclone/stdtransferclone', $data);

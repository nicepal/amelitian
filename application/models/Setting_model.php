...
class Setting_model extends MY_Model {
    ...
    public function getSetting() {
        ...
        $this->db->select('sch_settings.guardian_occupation,sch_settings.middlename,sch_settings.guardian_phone,sch_settings.student_profile_edit,sch_settings.guardian_name,sch_settings.start_week,sch_settings.my_question,sch_settings.id,sch_settings.attendence_type,sch_settings.lang_id,sch_settings.is_rtl,sch_settings.fee_due_days,sch_settings.class_teacher,sch_settings.cron_secret_key,sch_settings.timezone,
